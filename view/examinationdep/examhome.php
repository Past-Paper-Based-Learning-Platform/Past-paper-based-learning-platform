            ...
            <div id="uploadpastpapers" class="tabcontent" style="height: 600px;">
                ...
                <div class="col-3-item">
                    <div style="width: 50%; float: left">
                        <div class="col-2-item strong text-white">Year:</div>
                        <div class="col-4-item">
                            <input type="text" name="year" id="inputyear" value="<?php echo isset($_POST['year']) ? $_POST['year'] : date('Y'); ?>" onkeyup="stoppedTyping()">
                        </div>
                    </div>
                    <div style="width: 50%; float: left">
                        <div class="col-2-item strong text-white">Semester:</div>
                        <div class="col-4-item">
                            <input type="text" list="semester" name="semester" id="inputsemester" value="<?php echo isset($_POST['semester']) ? $_POST['semester'] : ''; ?>" onkeyup="stoppedTyping()">
                        </div> 
                    </div>
                    <div style="width: 50%; float: left">
                        <div class="col-2-item strong text-white">Course:</div>
                        <div class="col-4-item">
                            <input type="text" list="course" name="course" id="inputcourse" value="<?php echo isset($_POST['course']) ? $_POST['course'] : ''; ?>" onkeyup="stoppedTyping()">
                        </div> 
                    </div>
                    <div style="width: 50%; float: left">
                        <div class="col-2-item strong text-white">Year of Study:</div>
                        <div class="col-4-item">
                            <input type="text" list="studyyear" name="studyyear" id="inputstudyyear" value="<?php echo isset($_POST['studyyear']) ? $_POST['studyyear'] : ''; ?>" onkeyup="stoppedTyping()">                        
                        </div>
                    </div>
                    <div class="row">
                    <div class="col-2-item">
