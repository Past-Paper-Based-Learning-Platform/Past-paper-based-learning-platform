...
<div class='container' style="">
    <div class="tab">
        ...
        <a href='http://localhost/Main/lecturerindex.php?page=pastpaper.php&paper_id=<?php echo $paper_id; ?>'><button>Past Paper</button></a>
        </div>
        <div class="col-3-item" style='margin:auto;'>
        <a href='http://localhost/Main/lecturerindex.php?page=discussion.php&paper_id=<?php echo $paper_id; ?>'><button style="background:blue;">Discussion</button></a>
        </div>
    </div>
                ...
                foreach($result as $row) {
                    ...
                    if($discussion_id!=null && $parent_resource_id==null){
                            ...
                            if(isset($_SESSION['user_id'])){
                                ...
                                <form action='http://localhost/Main/lecturerindex.php' name='delete-form' method='POST' >
                                    ...
                                    <form action='http://localhost/Main/lecturerindex.php?page=paperedit.php&paper_id='".$row['paper_id']."'' name='edit-form' method='POST' >
                                    <input type='hidden' name='uid' value='".$row['resource_id']."'>
