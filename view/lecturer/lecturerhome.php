            ...
            <table class="table" style="width:100%;height:88%;table-layout: fixed">
                <tr>
                    <td style="width:20%;border: 1px solid black;text-align:center">
                        ...
                        <div style="text-align:center;">
                            <button class="tablinks bg-dblue border-dblue" style="width:60%" onclick="openTab(event, 'uploadans')">Scedule Meeting</button>
                        </div>
                    ...
                    <td style="width:60%;border: 1px solid black">
                        ...
                        <!-- Upload answer script Content -->
                        <div id="uploadans" class="tabcontent" style="height: 600px; display: none block;">
                            <form action="http://localhost/Mainmain/lecturerindex.php" method="POST" enctype="multipart/form-data">
                                <div>
                                ...
                                <div class="element">
                                    <button class="bg-dblue border-dblue" name= "upload_answers" type="submit" style="width:30%">UPLOAD</button>
                                </div>
                            </form>
                        </div>
