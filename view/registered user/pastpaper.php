...
<head>
    ...
    <link rel="stylesheet" href="libs/alert.css" type="text/css">
...
<body>
    ...
    <section class="pdf">
        ...
        <div class="discussionform" style="display:none;">
            <form action="http://localhost/Main/homeindex.php?page=pastpaper.php&paper_id=<?php echo $paper_id; ?>&subject_code=<?php echo $_GET['subject_code']; ?>" method="post" enctype="multipart/form-data" >
        ...
        <div class="content" id="content">
            ...
            <iframe src="<?php echo $answer_result ?>" style="display:none;" id="pdfans" frameborder="0"></iframe>
        </div>
    </section>
